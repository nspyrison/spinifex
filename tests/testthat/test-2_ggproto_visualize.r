...
test_that("animate_gganimate", {
  expect_equal(class(ag_mt  ), c("gif_image", "character"))
  expect_equal(class(ag_gt  ), c("gif_image", "character"))
  expect_equal(class(ag_mt1d), c("gif_image", "character"))
  expect_equal(class(ag_gt1d), c("gif_image", "character"))
  expect_equal(length(ag_mt)  , c(1L, 99L, 100L))
  expect_equal(length(ag_gt)  , c(1L, 99L, 100L))
  expect_equal(length(ag_mt1d), c(1L, 99L, 100L))
  expect_equal(length(ag_gt1d), c(1L, 99L, 100L))
})
