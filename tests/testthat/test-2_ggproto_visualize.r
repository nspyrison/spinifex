...
test_that("filmstrip", {
  ...
  expect_equal(length(fs_mt  ), expected_length)
  expect_equal(length(fs_gt  ), expected_length)
  expect_equal(length(fs_mt1d), expected_length)
  expect_equal(length(fs_gt1d), expected_length)
})
