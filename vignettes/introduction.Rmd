...
We'll use the flea dataset. The data consists of 74 observations of 6 physical disance measurements of a flea-beatle belonging to 1 of 3 speices. This is analogous to the iris dataset.
...
* `manip_type`, "horizontal", "vertical", or "radial", controling the the angle w.r.t. the basis' plane to rotate the variable.
...
Thanks to Dianne Cook for direction, namesake, and the ground work underpinning this work. Thanks to Ursla Laa for use cases and prompts to keep me focused.
