...
#spacemanip::this_manip_space <- create_manip_space(basis = basis_random(p = p), manip_var = 3)
```
...
for (i in seq(0, pi, pi/20)) {
  #this_r_space <- horizontal_manip(manip_space = this_manip_space, phi = i, theta = 45)
