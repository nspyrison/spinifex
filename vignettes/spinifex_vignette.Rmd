...
## Dynamic projections of high dimensional data
...
## Example 1 - Rotate an arbitrary basis
...
The following example will explore how changing the contributions of the variable, `aded2`, will affect the structure of the projection. We'll initialize a random basis and then view the manipulation space.
...
```{r}
play_manual_tour(data = flea_std, basis = flea_rb, manip_var = 5)
```
