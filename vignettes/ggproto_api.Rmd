...
tibble::tribble(
  ...
  "proto_basis /1d",    "geom- _segment & _text", "Direction and magnetude of variables to the projection displayed on a unit circle/rectangle.",
  "proto_default /1d", "several", "Default protos for 2/1D tours",
